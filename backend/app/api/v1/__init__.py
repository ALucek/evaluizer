...
from app.api.v1.endpoints import csv, evaluation, prompt, llm, judge, function_eval, metric, gepa
...
api_router.include_router(function_eval.router, prefix="/function-eval", tags=["function-eval"])
